<div>
    <div class="max-w-7xl mx-auto py-4 text-sm text-center text-gray-700 flex justify-between items-center sm:px-6 lg:px-8 px-6">
        <div>
            © 2023 {{ config('app.name') }}. Todos los derechos reservados.
        </div>
        <div>
            <a href="https://www.facebook.com/CETMAR39" target="_blank">
